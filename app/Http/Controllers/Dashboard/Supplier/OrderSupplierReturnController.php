...
{
    public function create(Suppliers $supplier , Request $request)
    {
    ...
    public function edit(Suppliers $supplier, OrderSupplierReturn $orders_return)
    {
        $stores = Store::all();
        $mony_stocks = MonyStock::all();
    ...
    public function update(Request $request, Suppliers $supplier, OrderSupplierReturn $orders_return)
    {
        $request->validate([
            'products' => 'required|array',
        ]);
